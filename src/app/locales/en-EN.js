angular.module('App.Locales').config(['$translateProvider', function($translateProvider) {
  $translateProvider.translations('en-EN', {
    ...
    "LANG_INVITE_MESSAGE_INVITE_SUCCESS": "Invited {{param}} people cooperation",
    "LANG_INVITE_MESSAGE_INVITE_ERROR": "Encountered a problem when you invite cooperation, please try again",
    ...
    "LANG_INVITE_SENTING_INVITATION": "Inviting…",
    "LANG_INVITE_ENTER_SEARCH": "Search",

    "*********************************************************": "Link-share",
    "LANG_LINK_PERMANENT": "Permanent",
    "LANG_LINK_EXPIRATION": "Expiration to",
    "LANG_LINK_MODIFIED_SETTING": "Modified Setting",
    "LANG_LINK_SEND_TO": "Send Link To",
    "LANG_LINK_SEND": "Send",
    "LANG_LINK_SENDING": "Sending…",
    "LANG_LINK_DELETE": "Delete Link",
    "LANG_LINK_SAVE_SETTING": "Save Setting",
    "LANG_LINK_CANCLE_SETTING": "Cancel Setting",
    ...
    "LANG_LINK_SEND_MAIL_ERROR": "Encountered a problem when sending link, please try again",
    ...
    "LANG_SEARCH_FILE_FIND": "Find {{length}} files(folders) about \"<font color=\"red\">{{keyword}}</font>\"",

    "*********************************************************": "files",
    "LANG_FILES_CREATE_FOLDER_SUCCESS_MESSAGE": "Your folder has been created successfully",
    "LANG_FILES_CREATE_FOLDER_ERROR_MESSAGE": "Encountered a problem when creating folder, please try again",
    ...
    "LANG_FILES_NOT_MORE_THAN_5G": "Upload size not more than 5G",
    ...
    "LANG_DELETE_GROUP_CONFIRM_BUTTON": "Remove",
    ...
    "LANG_DELETE_SHARE_USER_CONFIRM_BUTTON": "Remove",
    ...
    "*********************************************************": "team",
    "LANG_TEAM_UPDATE_AUTHORITY_SUCCESS_MESSAGE": "Updated {{param}} for {{param1}}",
    "LANG_TEAM_UPDATE_AUTHORITY_ERROR_MESSAGE": "Encountered a problem when you change the authority of cooperation, please try again",
    "LANG_TEAM_DELETE_COLLABORATION_SUCCESS_MESSAGE": "Deleted {{param}} from this folder",
    "LANG_TEAM_DELETE_COLLABORATION_ERROR_MESSAGE": "Encountered a problem when you remove people collaboration, please try again",
    ...
    "LANG_TEAM_COLLABORATION_RECENT_DISCUSSION":"Recent Discussion",
    "LANG_TEAM_COLLABORATION_HAD_HIDDEN_DISCUSSION":"Hidden Discussion",
    "LANG_TEAM_COLLABORATION_RECENT_VISIT_LINK":"Recent Visit Link",
    "LANG_TEAM_COLLABORATION_MY_LINK":"My Link",
    "LANG_TEAM_COLLABORATION_FILE_NAME":"Name",
    "LANG_TEAM_COLLABORATION_CREATION_TIME":"Creation Time",
    "LANG_TEAM_COLLABORATION_FILE_OPERATION":"Operation",
    "LANG_TEAM_COLLABORATION_ACCESS_TIME":"Access Time",
    "LANG_TEAM_COLLABORATION_VERSION": "Version {{length}}",
    "LANG_TEAM_COLLABORATION_OPEN": "Click here to open notice",
    "LANG_TEAM_COLLABORATION_CLOSE": "Click here to close notice",
    "LANG_TEAM_COLLABORATION_OTHERS": "Cooperators",
    "LANG_TEAM_COLLABORATION_NOTICE_CLOSE": "Notice is closed",
    "LANG_TEAM_COLLABORATION_NOTICE_OPEN": "Notice is open",
    "LANG_TEAM_COLLABORATION_FILE_DELETE": "The file is deleted.",

    "LANG_TEAM_COLLABORATION_UPLOAD_FILE": "uploaded the file",
    "LANG_TEAM_COLLABORATION_CREATE_NOTE": "created the note",
    "LANG_TEAM_COLLABORATION_UPDATE_FILE": "updated the file",
    "LANG_TEAM_COLLABORATION_UPDATE_NOTE": "updated the note",
    "LANG_TEAM_COLLABORATION_DELETE_FILE": "deleted the file",
    "LANG_TEAM_COLLABORATION_DELETE_FOLDER": "deleted the folder",
    "LANG_TEAM_COLLABORATION_REVERT_FILE": "reverted the file",
    "LANG_TEAM_COLLABORATION_PREVIEW_FILE": "previewed file",
    "LANG_TEAM_COLLABORATION_DOWNLOAD_FILE": "download the file",
    "LANG_TEAM_COLLABORATION_LEAVE_FOLDER": "quit the folder",
    "LANG_TEAM_COLLABORATION_BY": "by ",
    "LANG_TEAM_COLLABORATION_FROM": " is changed from ",
    "LANG_TEAM_COLLABORATION_TO": " to ",
    "LANG_TEAM_COLLABORATION_JION":" is invited into the folder with the permission of ",
    "LANG_TEAM_COLLABORATION_KICKOUT": " is removed from the folder ",
    "LANG_TEAM_COLLABORATION_TODAY_DATE": "Today",
    ...
    "LANG_FILE_DELETE_SUCCESS_MESSAGE": "Delete the {{param}} records",
    "LANG_FILE_DELETE_ERROR_MESSAGE": "Encountered a problem when you delete a file, please try again",
    "LANG_FILE_MOVE_SUCCESS_MESSAGE": "moved {{param}} records to \"{{param1}}\"",
    "LANG_FILE_MOVE_FAILED_ERROR": "Encountered a problem when you move a file, please try again",
    "LANG_FILE_MOVE_FAILED_MESSAGE": "Move failed",
    "LANG_FILE_COPY_SUCCESS_MESSAGE": "Copied {{param}} to {{param1}}",
    ...
    "LANG_HEADER_COMBO_USED": "You are using",
    ...
    "LANG_HEADER_DELETE_FOLDER": "I'm sorry this folder has been removed",
    "LANG_HEADER_DELETE_FILE": "I'm sorry the file has been deleted",
    ...
    "LANG_SIDE_BAR_ALL_DISCUSSION": "Discuss",
    "LANG_SIDE_BAR_LINK": "Link",
    ...
    "*********************************************************": "Links",
    "LANG_LINKS_DELETE_MYLINK": "Delete Mylink",
    "LANG_LINKS_DELETE_MYLINK_CONFIRM_MESSAGE": "It will cancel the share for \"{{param}}\", Are you sure to delete it?",
    "LANG_FILES_DELETE_MYLINK_SUCCESS_MESSAGE": "Has canceled the share for \"{{param}}\"",
    "LANG_LINKS_DELETE_RECORDLINK": "Delete Recordlink",
    "LANG_LINKS_DELETE_RECORDLINK_CONFIRM_MESSAGE": "Are you sure to delete it",
    "LANG_FILES_DELETE_RECORDLINK_SUCCESS_MESSAGE": "Delete success",
    "LANG_FILES_SEND_MAIL_ERROR": "Please select users or groups",
    ...
    "LANG_NOTE_BACK": "Back",
    "LANG_NOTE_EDIT": "Edit",
    "LANG_NOTE_PUBLISH": "Publish",
    "LANG_NOTE_OPEN_DISCUSS": "Open Discuss",
    "LANG_NOTE_INPUT_TITLE": "Please input title",
    "LANG_NOTE_PUBLISH_SUCCESS": "Created a new note",
    "LANG_NOTE_UPDATE_SUCCESS": "Updated a note",
    ...
    "LANG_TRASH_REVERT_SELECTED_FILES": "Has reverted the selected file(s)", 
    ...
    "LANG_TRASH_DELETE_COMFIRM_DELETE_CONFIRM": "Completely deleted files will not be able to recover. Are you sure you want to delete the selected file(s)?",
